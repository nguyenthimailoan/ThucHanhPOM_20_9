...
public class WebUI {
    ...
    public static String getCssValue(By by, String cssvalueName) {
        waitForElementVisible(by);
        logConsole("Get cssvalue value of element " + by);
        logConsole("==> cssvalue value: " + getWebElement(by).getCssValue("background-color"));
        return getWebElement(by).getCssValue(cssvalueName);
    }
